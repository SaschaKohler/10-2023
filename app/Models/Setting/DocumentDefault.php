...
class DocumentDefault extends Model
{
    ...
    protected function logoUrl(): Attribute
    {
        return Attribute::get(
            static function (mixed $value, array $attributes): ?string {
    ...
    public static function getAvailableItemQtyOptions(): array
    {
        $options = [
            'anzahl' => 'Anzahl',
            'menge' => 'Menge',
    ...
    public function getLabelOptionFor(string $optionType, ?string $optionValue)
    {
        ...
        $options = match ($optionType) {
            ...
            'item_qty' => static::getAvailableItemQtyOptions(),
